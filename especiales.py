    ...
    def pivoteS(self):
        ...
        if self.funcion == "Min z":
            try:
                ...
                messagebox.showwarning("Advertencia", "Esta es una Solucion no acotada")
                self.abierto = True
        else:
            try:
                minomax = min(i for i in lista if i >= 0)
                ...
                messagebox.showwarning("Advertencia", "Esta es un solucion no acotada")
                self.abierto = True
        ...
        if(repit>1):
            for i in range(len(lista)):
                if(lista[i]==minomax):
                    self.pivotefc[1]=(i+2)
            messagebox.showwarning("Advertencia", "Este es un Punto degenerado")
